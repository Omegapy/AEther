...
- [ ] Decide whether the fixed-completion unit-lapse trace/auxiliary package should next be repaired by a propagated trace-monopole cancellation, a renormalized auxiliary Coulomb profile, or a weighted/homogeneous function class.
- [ ] After that smaller repair is chosen, retest whether the fixed-completion unit-lapse spatial-harmonic formulation supports a local well-posedness/continuation statement and a coercive or decay architecture.
