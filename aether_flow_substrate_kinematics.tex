...
\end{equation}
where \(G \equiv \det G_{AB}\), subject to the unit constraint \eqref{eq:unitflow} and monotonicity condition \eqref{eq:ordermonotone}. Here \(\psi\) denotes the matter sector that must eventually be recovered in observer-accessible form.
