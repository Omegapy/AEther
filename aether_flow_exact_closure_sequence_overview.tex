...
This note is the canonical front door to the exact-closure sequence. After it, the active core manuscripts should be read in the following order.
\begin{enumerate}
