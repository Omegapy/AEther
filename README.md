...
This repository documents an AI experiment in theoretical physics research. The goal is to research whether an AI can develop a new feasible interpretation of relativity from a concept.
