...
The next major burden is therefore narrower again: prove the first local well-posedness and continuation criterion for that explicit minimal completion, including slice-wise control of the auxiliary elliptic constraints and persistence of the positivity assumptions. Any later return to admissible-background widening would still require a genuinely new higher-order localization mechanism rather than another small weakening of the current patch-control hypothesis.
...
- [RESEARCH_PLAN.md](/Volumes/P-SSD/The Æther/RESEARCH_PLAN.md) now tracks the live branch-testing program and the post-completion shift to proving the first local well-posedness and continuation result for the chosen explicit completion.
