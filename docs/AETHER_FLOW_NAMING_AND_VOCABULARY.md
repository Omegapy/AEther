...
- the next substantive research step is now to choose one explicit tuned-compensator nonlinear completion and derive its first reduced-system/local-coercive note on the replacement tuned auxiliary-elliptic branch
