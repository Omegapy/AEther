...
- the next active manuscript burden is now a broader replacement redesign note targeted at removing that generic Stueckelberg-like infrared bridge remainder without annihilating the ordered-flow equation, with the bridge metric and single-metric matter route preserved if possible and the smallest fixed-route obstruction recorded if not
