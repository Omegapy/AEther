...
- the next active manuscript burden is now the explicit symmetry/quotient route if the bridge metric and single-metric matter route are still to be preserved
