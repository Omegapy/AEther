...
- the immediate next manuscript should now be the compensator-branch consistency/reduction note rather than another asymptotic or bridge-tensor note on the old quartic side program
- the next substantive research step is now to carry that compensator branch through its full quadratic reduction and verify the full \(\Pi_\phi\)-removal, matter-route preservation, and auxiliary-gap claims
