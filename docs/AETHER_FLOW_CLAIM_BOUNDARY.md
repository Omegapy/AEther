...
- the next major burden is now a post-verdict next-branch or redesign-criteria note that archives the surviving quartic branch at the right status and defines the smallest admissible requirements for the next derivational candidate beyond it
