...
- a repaired local well-posedness, coercive-control, and decay analysis of the fixed-completion gauge-first reformulation after the recorded trace-driven longitudinal auxiliary obstruction in [aether_flow_substrate_higher_derivative_unit_lapse_trace_auxiliary_obstruction.tex](/Volumes/P-SSD/The Æther/aether_flow_substrate_higher_derivative_unit_lapse_trace_auxiliary_obstruction.tex)
- if that repaired unit-lapse route fails, a decision on which deeper nonlinear-completion or auxiliary change should then be tried next
...
- the next major burden is to determine whether that fixed-completion gauge-first reformulation can be repaired at the trace/auxiliary level before any deeper completion change is attempted
