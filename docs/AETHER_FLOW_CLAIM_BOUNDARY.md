...
- a corrected coercive bootstrap analysis for the fixed-completion gauge-first unit-lapse route after the weighted/homogeneous longitudinal closure note [aether_flow_substrate_higher_derivative_unit_lapse_weighted_homogeneous_closure_test.tex](/Volumes/P-SSD/The Æther/aether_flow_substrate_higher_derivative_unit_lapse_weighted_homogeneous_closure_test.tex), before any dedicated decay test is attempted
- if that post-local weighted/homogeneous unit-lapse route fails, a decision on which deeper nonlinear-completion or auxiliary change should then be tried next
...
- the next major burden is now the weighted/homogeneous coercive-bootstrap test for that fixed-completion gauge-first unit-lapse route, with any dedicated decay test postponed until after that bootstrap step
...
- the weighted or homogeneous reformulation of the unit-lapse route already proves a corrected coercive bootstrap, a decay theorem, or a deeper nonlinear-stability statement
