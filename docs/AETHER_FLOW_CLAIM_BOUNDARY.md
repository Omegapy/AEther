...
- a dedicated same-class asymptotic/nonlinear-stability closure manuscript for the fixed-completion gauge-first unit-lapse weighted/homogeneous route, tentatively [aether_flow_substrate_higher_derivative_unit_lapse_weighted_homogeneous_asymptotic_closure_test.tex](/Volumes/P-SSD/The Æther/aether_flow_substrate_higher_derivative_unit_lapse_weighted_homogeneous_asymptotic_closure_test.tex), after the now-recorded decay/integrability note [aether_flow_substrate_higher_derivative_unit_lapse_weighted_homogeneous_decay_integrability_test.tex](/Volumes/P-SSD/The Æther/aether_flow_substrate_higher_derivative_unit_lapse_weighted_homogeneous_decay_integrability_test.tex)
- in that next same-class note, a closure of the decay bootstrap itself, a choice of asymptotic variables or profiles for the low-frequency trace--longitudinal wave pair, the high-frequency Einstein wave sector, and the quartic scalar Schr\"odinger channel, and a proof-or-failure test for the Duhamel closure based on the now-recorded \(L_t^1\) nonlinear remainder
- if that broader same-class weighted/homogeneous asymptotic-closure route later fails, a decision on which deeper nonlinear-completion or auxiliary change should then be tried next
...
- the next major burden is now the same-class asymptotic/nonlinear-stability closure test for that fixed-completion gauge-first weighted/homogeneous unit-lapse route, tentatively [aether_flow_substrate_higher_derivative_unit_lapse_weighted_homogeneous_asymptotic_closure_test.tex](/Volumes/P-SSD/The Æther/aether_flow_substrate_higher_derivative_unit_lapse_weighted_homogeneous_asymptotic_closure_test.tex), with any deeper completion change deferred unless that broader same-class route later fails
