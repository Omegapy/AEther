...
- a weighted/homogeneous decay/integrability analysis for the fixed-completion gauge-first unit-lapse route, tentatively [aether_flow_substrate_higher_derivative_unit_lapse_weighted_homogeneous_decay_integrability_test.tex](/Volumes/P-SSD/The Æther/aether_flow_substrate_higher_derivative_unit_lapse_weighted_homogeneous_decay_integrability_test.tex), after the now-recorded weighted/homogeneous coercive-bootstrap note [aether_flow_substrate_higher_derivative_unit_lapse_weighted_homogeneous_coercive_bootstrap_test.tex](/Volumes/P-SSD/The Æther/aether_flow_substrate_higher_derivative_unit_lapse_weighted_homogeneous_coercive_bootstrap_test.tex)
- if that broader post-local weighted/homogeneous unit-lapse route fails, a decision on which deeper nonlinear-completion or auxiliary change should then be tried next
...
- the next major burden is now the weighted/homogeneous decay/integrability test for that fixed-completion gauge-first unit-lapse route, with any deeper completion change deferred unless that broader post-local route fails
