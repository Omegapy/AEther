...
- keep the overview-first exact-closure package fixed as the main deliverable
- keep the derivational bridge downstream and optional in public presentation
